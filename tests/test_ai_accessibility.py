...
"Wilson, Bob","Product Manager, B2B Solutions",90000"""
        ...
        assert preview_records[1]["description"] == "Data Scientist, Machine Learning Expert"

    async def test_escaped_quotes_in_csv(self) -> None:
        """Test that escaped quotes within quoted values are handled correctly."""
        csv_content = '''product,description,notes
...
Alice Johnson,"789 Pine St, Building C",555-0156,"""
        ...
        assert preview_records[2]["address"] is None
        assert preview_records[3]["notes"] is None
