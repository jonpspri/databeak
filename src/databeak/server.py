...
async def get_csv_data(session_id: str) -> dict[str, Any]:  # type: ignore[explicit-any]  # Any justified: MCP resource flexible response  # type: ignore[explicit-any]  # Any justified: MCP resource flexible response
...
async def get_csv_schema(session_id: str) -> dict[str, Any]:  # type: ignore[explicit-any]  # Any justified: MCP resource flexible response
...
async def list_active_sessions() -> list[dict[str, Any]]:  # type: ignore[explicit-any]  # Any justified: MCP resource list response
...
async def get_csv_cell(session_id: str, row_index: str, column: str) -> dict[str, Any]:  # type: ignore[explicit-any]  # Any justified: MCP resource flexible response
...
async def get_csv_row(session_id: str, row_index: str) -> dict[str, Any]:  # type: ignore[explicit-any]  # Any justified: MCP resource flexible response
...
async def get_csv_preview(session_id: str) -> dict[str, Any]:  # type: ignore[explicit-any]  # Any justified: MCP resource flexible response
