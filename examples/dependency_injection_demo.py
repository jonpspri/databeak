...
This script shows how the new dependency injection architecture improves
testability and reduces coupling between server modules and session management.
"""
...
async def demonstrate_before_after():
    ...
    if 'sales' in stats_result.statistics:
        ...
        print(f"   ✓ Sales stats - Mean: {sales_stats.mean:.2f}, Min: {sales_stats.min}, Max: {sales_stats.max}")
    ...
    try:
        ...
        if 'sales' in correlation_result.correlation_matrix and 'profit' in correlation_result.correlation_matrix['sales']:
...
if __name__ == "__main__":
    ...
    print(f"Starting DataBeak Dependency Injection Demo at {datetime.now()}")
    print()
